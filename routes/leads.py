...
def bulk_create_leads(leads: list[LeadOut]):
    ...
    ON CONFLICT (message_id) DO UPDATE SET
        ...
        rellamar_en = EXCLUDED.rellamar_en,
        reagendar_tipo = EXCLUDED.reagendar_tipo,
        nocontacto_intentos = EXCLUDED.nocontacto_intentos,
        ...
        timestamp_sheet = EXCLUDED.timestamp_sheet,
        documento = EXCLUDED.documento,
        compania = EXCLUDED.compania,
        operacion = EXCLUDED.operacion,
        tsource = EXCLUDED.tsource,
        modal = EXCLUDED.modal,
        direccion = EXCLUDED.direccion,
        email = EXCLUDED.email,
        fecha_cierre = EXCLUDED.fecha_cierre,
        notas = EXCLUDED.notas,
        minutos_asignacion = EXCLUDED.minutos_asignacion,
        seguimiento_tomado_por = EXCLUDED.seguimiento_tomado_por,
        seguimiento_tomado_en = EXCLUDED.seguimiento_tomado_en,
        liberado_por = EXCLUDED.liberado_por,
        liberado_en = EXCLUDED.liberado_en,
        liberado_motivo = EXCLUDED.liberado_motivo,
