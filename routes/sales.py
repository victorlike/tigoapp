...
def bulk_create_sales(sales: list[SaleCreate]):
    ...
    ON CONFLICT (message_id) DO UPDATE SET
        ...
        tipo_venta_original = EXCLUDED.tipo_venta_original,
        cliente_nombre = EXCLUDED.cliente_nombre,
        cliente_cedula = EXCLUDED.cliente_cedula,
        cliente_email = EXCLUDED.cliente_email,
        cliente_telefono = EXCLUDED.cliente_telefono,
        dir_depto = EXCLUDED.dir_depto,
        dir_ciudad = EXCLUDED.dir_ciudad,
        dir_barrio = EXCLUDED.dir_barrio,
        dir_calle = EXCLUDED.dir_calle,
        venta_plan = EXCLUDED.venta_plan,
        venta_equipo = EXCLUDED.venta_equipo,
        venta_pago = EXCLUDED.venta_pago,
        vendedor_comentarios = EXCLUDED.vendedor_comentarios,
        tip_tipo = EXCLUDED.tip_tipo,
        tip_resultado = EXCLUDED.tip_resultado,
        tip_motivo = EXCLUDED.tip_motivo,
        tip_submotivo = EXCLUDED.tip_submotivo,
        cliente_vendedor = EXCLUDED.cliente_vendedor,
        cliente_nacimiento = EXCLUDED.cliente_nacimiento,
        dir_loc = EXCLUDED.dir_loc,
        dir_puerta = EXCLUDED.dir_puerta,
        dir_tipo = EXCLUDED.dir_tipo,
        dir_apto = EXCLUDED.dir_apto,
        dir_esq1 = EXCLUDED.dir_esq1,
        dir_esq2 = EXCLUDED.dir_esq2,
        venta_vigencia = EXCLUDED.venta_vigencia,
        venta_clc = EXCLUDED.venta_clc,
        venta_llevaequipo = EXCLUDED.venta_llevaequipo,
        venta_precio = EXCLUDED.venta_precio,
        venta_cuotas = EXCLUDED.venta_cuotas,
        dg_solicita = EXCLUDED.dg_solicita,
        dg_importe = EXCLUDED.dg_importe,
        dg_corresponde = EXCLUDED.dg_corresponde,
        envio_tipo = EXCLUDED.envio_tipo,
        envio_detalles = EXCLUDED.envio_detalles,
        cobro_importe = EXCLUDED.cobro_importe,
        cobro_motivo = EXCLUDED.cobro_motivo,
        cobro_linkemail = EXCLUDED.cobro_linkemail,
        link_enviado = EXCLUDED.link_enviado,
        nombre_link = EXCLUDED.nombre_link,
        plateran_cargado = EXCLUDED.plateran_cargado,
        plateran_so = EXCLUDED.plateran_so,
        estado_pedido = EXCLUDED.estado_pedido,
        controldoc_subido = EXCLUDED.controldoc_subido,
        controldoc_estado = EXCLUDED.controldoc_estado,
        porta_nip = EXCLUDED.porta_nip,
        vendedor_comentarios_por = EXCLUDED.vendedor_comentarios_por,
        vendedor_comentarios_at = EXCLUDED.vendedor_comentarios_at,
        backoffice_status = EXCLUDED.backoffice_status,
        backoffice_sub_status = EXCLUDED.backoffice_sub_status,
        backoffice_agent = EXCLUDED.backoffice_agent,
        backoffice_at = EXCLUDED.backoffice_at,
        backoffice_notas = EXCLUDED.backoffice_notas,
        origen = EXCLUDED.origen,
        valor_plan = EXCLUDED.valor_plan,
        valor_telefono = EXCLUDED.valor_telefono,
